...
async fn test_flex_processing_warning_unsupported() {
    ...
    // for gpt-4o-mini model, and service_tier should be removed from request
}
...
#[tokio::test]
#[ignore = "Requires priority processing model validation and warning system - not yet implemented"]
async fn test_priority_processing_warning_unsupported() {
    // TypeScript reference: line 1621
    // Test that warning is shown when using priority processing with unsupported model
    //
    // TODO: Implement model validation for priority processing
    // TODO: Remove service_tier from request for unsupported models
    // TODO: Return warning about priority processing not available
    let test_server = TestServer::new().await;
    ...
    // Warning should be returned about priority processing not being available
    // for gpt-3.5-turbo model, and service_tier should be removed from request
}
